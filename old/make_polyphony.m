function make_polyphony()
    ...
    voices_y = [14 15 16 17 24 25 26 27 34 35 36 37];
    ...
    for i=0:blksize:max(grid_minor)
        ...
        plot(v1_4, repmat(voices_y(1), 1, length(v1_4)), 'r.', ...
            ...
            v1_5_beats, repmat(voices_y(2), 1, length(v1_5_beats)), 'ro', ...
            v1_6_beats, repmat(voices_y(3), 1, length(v1_6_beats)), 'ro', ...
            v1_7_beats, repmat(voices_y(4), 1, length(v1_7_beats)), 'ro', ...
            ...
            v2_4_beats, repmat(voices_y(5), 1, length(v2_4_beats)), 'go', ...
            v2_5_beats, repmat(voices_y(6), 1, length(v2_5_beats)), 'go', ...
            v2_6_beats, repmat(voices_y(7), 1, length(v2_6_beats)), 'go', ...
            v2_7_beats, repmat(voices_y(8), 1, length(v2_7_beats)), 'go', ...
            ...
            v3_4_beats, repmat(voices_y(9), 1, length(v3_4_beats)), 'bo', ...
            v3_5_beats, repmat(voices_y(10), 1, length(v3_5_beats)), 'bo', ...
            v3_6_beats, repmat(voices_y(11), 1, length(v3_6_beats)), 'bo', ...
            v3_7_beats, repmat(voices_y(12), 1, length(v3_7_beats)), 'bo', ...
            ...
        	gminor, repmat(0., 1, length(gminor)), '.', ...
            subarray(grid_major, i, blksize + i), repmat(0., 1, length(subarray(grid_major, i, blksize + i))), 'o', ...
            ...
            gminor, repmat(13, 1, length(gminor)), 'k.', ...
            subarray(grid_major, i, blksize + i), repmat(13, 1, length(subarray(grid_major, i, blksize + i))), 'ko', ...
            ...
            gminor, repmat(23, 1, length(gminor)), 'k.', ...
            subarray(grid_major, i, blksize + i), repmat(23, 1, length(subarray(grid_major, i, blksize + i))), 'ko', ...
            ...
            gminor, repmat(33, 1, length(gminor)), 'k.', ...
            subarray(grid_major, i, blksize + i), repmat(33, 1, length(subarray(grid_major, i, blksize + i))), 'ko', ...
            ...
            %{
            ...
            gminor, er / 1000., '*', ...
            ...
            ...
            grid_tempo_x, grid_tempo_y, 'k-', ...
            grid_tempo_x, grid_tempo_y * 8, 'k-', ...
            ...
            [i (i+blksize)], [0 0], '-', ...
            ...
